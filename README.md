# 👤 [Caroline.Zou] - 主页 Mainpage

[![GitHub](https://img.shields.io/badge/GitHub-主页-blue)](https://github.com/username)
[![arXiv](https://img.shields.io/badge/arXiv-论文-orange)](https://arxiv.org/a/yourname)
[![Google Scholar](https://img.shields.io/badge/Google-Scholar-green)](https://scholar.google.com/citations?user=xxx)
...
- **[The impact of the construction of national entrepreneurship and entrepreneurship demonstration base on the digital transformation of enterprises: an empirical analysis based on PSM-DID](https://github.com/CarolineZOU/Thesis/blob/main/2025%20An%20empirical%20analysis%20based%20on%20PSM-DID_CN.pdf)** -2025, World Economic Literature Introduction Paper(CN version only)
- **[HO-STGCN: A Multi-City, Multi-Pollutant Collaborative Prediction Model Based on Spatio-Temporal Graph Convolutional Network and Hybrid Optimization Algorithm — A Case Study on Air Quality Prediction in the Jing-Jin-Ji Region](https://github.com/CarolineZOU/Thesis/blob/main/2025%20HO-STGCN%20Optimization%20Algorithm_EN.pdf)** - 2025, The 11th China National College Student Statistical Modeling Competition
